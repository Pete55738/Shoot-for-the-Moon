...
- [ ] T33 · "on the ground the mission control window should be gone; the readiness window describing what's happening stays until launch; once it launches that goes away and bottom left is the gimbal" · said 09-05 · **decided:** turnaround shows the readiness checklist in the top-left slot and hides mission control; flight hides readiness, shows mission control top-left and the gimbal bottom-left · next
- [ ] T34 · "add a bunch more mechanics for when they're assembling the ship, and more jokey names for what they're doing — cleaning, cleaning space biffy, stuff like that" · said 09-05 · **decided:** more turnaround stages with their own animation, and a much longer jokey task pool · next
